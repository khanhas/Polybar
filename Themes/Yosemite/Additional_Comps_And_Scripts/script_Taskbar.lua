...
function DrawSubProcessShape(TotalRunning,CurrentDrawingIndex,CurrentActiveWindow)
	...
	for j = 0,TotalRunning do
		SKIN:Bang('!SetOption SubprocessTrackingShape Shape'..shapeCount..' "Ellipse '..(processWidth/2 + processWidth * CurrentDrawingIndex - totalDotSpace/2 + j*DotGap)..','..dotPosition..',2.5 | StrokeWidth 0 | Extend '..DotTrait..'"')
